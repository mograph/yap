<script lang="ts">
  ...
  const paths: Record<string, string> = {
    ...
    chart: '<path d="M3 3v18h18"/><path d="M7 16v-3M11 16V9M15 16v-6M19 16V6"/>',
    ...
    sparkle: '<path d="M12 3l1.9 5.6 5.6 1.9-5.6 1.9L12 18l-1.9-5.6L4.5 10.5l5.6-1.9z"/><path d="M19 17l.7 1.8 1.8.7-1.8.7L19 22l-.7-1.8-1.8-.7 1.8-.7z"/>',
